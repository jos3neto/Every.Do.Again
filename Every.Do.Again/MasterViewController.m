...
- (void)insertNewObject:(id)sender //inserts M.O. to the controller
{
    NSManagedObjectContext* context = [self.fetchedResultsController managedObjectContext];
    Todo* newTodo = [[Todo alloc] initWithContext:context];
        
    // If appropriate, configure the new managed object.
    newTodo.title = [NSDate date].description;
...
- (NSFetchedResultsController<Todo*>*)fetchedResultsController //getter override
{
...
{
    [self.tableView endUpdates]; //this guy updates the table view
}
